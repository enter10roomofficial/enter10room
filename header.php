        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            <a class="flex title-font font-medium items-center text-white mb-4 md:mb-0">
              ...
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
                ...
                <span class="ml-3 text-xl">Enter10room</span>
            </a>
            <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                <a href="index.php" class="mr-5 hover:text-white">Home</a>
                <a href="posts.php" class="mr-5 hover:text-white">Post</a>
                <a href="about.php" class="mr-5 hover:text-white">About</a>
                <a href="contact.php" class="mr-5 hover:text-white">Contact us</a>
                <!-- <a href="/" class="mr-5 hover:text-white">privacy-policy</a> -->
            </nav>
            <!-- <button class="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0">Next
